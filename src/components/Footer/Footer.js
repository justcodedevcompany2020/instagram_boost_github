  ...
  return (
    <footer>
      ...
      <div className='footer-items'>
        ...
        <div className='foot-item1'> <h3>Help</h3>
        ...
        <div className='foot-item1'> <h3>Resources</h3>
          <p>Free eBooks</p>
      ...
      <div className='mob-menu'>
        <div className='mob'>
          ...
          <div className='icons5'>
            <p><BsTwitter size='1.5rem' /></p>
            <p> <FaFacebook size='1.5rem' /></p>
            <p><SiInstagram size='1.4rem' /></p>
            <p> <SiGithub size='1.4rem' /></p>
          </div>
        </div>
